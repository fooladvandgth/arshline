      ...
      sWrap.innerHTML = [
        ...
        '<div class="field" style="display:flex;gap:8px;align-items:center;margin-bottom:.6rem;">',
          ...
          '<label class="toggle-switch" title="اجباری" style="transform:scale(.9)">',
            '<input type="checkbox" id="mcRequired">',
        ...
        '<div class="field" style="display:flex;gap:8px;align-items:center;margin-bottom:.6rem;">',
          ...
          '<label class="toggle-switch" title="چندان‌انتخابی" style="transform:scale(.9)">',
        ...
        '<div class="field" style="display:flex;gap:8px;align-items:center;margin-bottom:.6rem;">',
          ...
          '<label class="toggle-switch" title="نمایش عمودی" style="transform:scale(.9)">',
            '<input type="checkbox" id="mcVertical">',
            '<span class="toggle-switch-background"></span>',
            '<span class="toggle-switch-handle"></span>',
          '</label>',
        '</div>',
        '<div class="field" style="display:flex;gap:8px;align-items:center;margin-bottom:.6rem;">',
          ...
          '<label class="toggle-switch" title="تصادفی‌سازی" style="transform:scale(.9)">',
            '<input type="checkbox" id="mcRandomize">',
            '<span class="toggle-switch-background"></span>',
            '<span class="toggle-switch-handle"></span>',
          '</label>',
        '</div>',
