(function(window, document){
  ...
  function defaults(){
    return { type:'thank_you', label:'پیام تشکر', heading:'با تشکر از شما', message:'', image_url:'' };
  }
  ...
  function renderEditor(field, ctx){
    try {
      ...
      sWrap.innerHTML = [
        '<div class="title" style="margin-bottom:.6rem;">تنظیمات پیام تشکر</div>',
        '<div class="field" style="display:flex;flex-direction:column;gap:6px;margin-bottom:8px;">',
          '<label class="hint">تیتر</label>',
          '<input id="fHeading" class="ar-input" placeholder="مثال: با تشکر از شما"/>',
        '</div>',
        '<div class="field" style="display:flex;flex-direction:column;gap:6px;margin-bottom:8px;">',
          '<label class="hint">متن</label>',
          '<textarea id="fMessage" class="ar-input" rows="3" placeholder="پیام تشکر"></textarea>',
        '</div>',
        '<div class="field" style="display:flex;flex-direction:column;gap:6px;margin-bottom:8px;">',
