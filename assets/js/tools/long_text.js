(function(window, document){
  ...
  '  <label class="toggle-switch" title="عدم نمایش شماره سؤال" style="transform:scale(.9)">',
  '    <input type="checkbox" id="fHideNumber" />',
  '    <span class="toggle-switch-background"></span>',
  '    <span class="toggle-switch-handle"></span>',
  '  </label>',
      '</div>',
  ...
  '  <label class="toggle-switch" title="توضیحات" style="transform:scale(.9)">',
  ...
  '  <label class="toggle-switch" title="امکان آپلود عکس" style="transform:scale(.9)">',
  '    <input type="checkbox" id="fMediaUpload" />',
  '    <span class="toggle-switch-background"></span>',
  '    <span class="toggle-switch-handle"></span>',
  '  </label>',
      '</div>',
