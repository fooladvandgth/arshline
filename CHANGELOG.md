...
- تاریخ: 2025-09-28
- شرح: نسخهٔ پایدار با تمرکز بر سلامت سازندهٔ فرم و ادیتور، پایداری «هوشیار» در حالت هیبرید/کامل، و آغاز زیرساخت «تعریف کاربران فرم» (گروه‌ها و دسترسی‌ها). درگ‌اَند‌دراپ مرتب‌سازی سؤالات و کشیدن از جعبه‌ابزار به بوم افزوده شد؛ رندرها تک‌مرحله‌ای و بدون پرش، و درخواست‌های تکراری حذف شدند.
- نکات برجسته:
